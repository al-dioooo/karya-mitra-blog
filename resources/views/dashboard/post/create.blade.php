...
<x-app-layout>
    ...
    <div>
        <div class="py-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <x-form.layout.section submit="{{ route('dashboard.post.store') }}" method="POST"
                title="{{ __('ui.post.create') }}" x-data="formData()" encoding="multipart/form-data">
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 md:col-span-4">
                        ...
                        <x-input-image aspect-w="16" aspect-h="9" class="mt-1" name="cover" id="cover" />
                    ...
                    <div class="col-span-6 space-y-4 md:col-span-2">
                        ...
                        <div x-show="lang == 'en'">
                            ...
                            <x-input x-model="title_en" id="english_title" name="english_title" type="text"
                        ...
                        <div x-show="lang == 'id'">
                            ...
                            <x-input x-model="title_id" id="indonesia_title" name="indonesia_title" type="text"
                                class="block w-full mt-1" />
                        ...
                        <div x-show="lang == 'en'">
                            ...
                            <x-input-textarea id="english_subtitle" name="english_subtitle" class="block w-full mt-1"
                                rows="3">
                                {{ old('english_subtitle') }}</x-input-textarea>
                        ...
                        <div x-show="lang == 'id'">
                            ...
                            <x-input-textarea id="indonesia_subtitle" name="indonesia_subtitle"
                                class="block w-full mt-1" rows="3">
                                {{ old('indonesia_subtitle') }}</x-input-textarea>
                        ...
                        <div>
                            ...
                            <x-input id="slug" name="slug" x-bind:value="slugify(title_en)" type="text"
                                class="block w-full mt-1" />
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <x-input-select-multi for="category" :items="$category"
                                    header="{{ __('ui.category.select') }}" class="w-11/12" />
                                <x-button href="{{ route('dashboard.category.create') }}" target="_blank"
                        ...
                        <div>
                            ...
                            <x-input-tag for="tag" class="mt-1" />
                            <x-input-info for="tag" message="Separate tags with comma or enter"
                                class="mt-2" />
                    ...
                    <div class="col-span-6" x-show="lang == 'en'">
                        <x-jet-label for="content" value="{{ __('ui.post.content') . ' ' . __('[EN]') }}"
                            class="mb-1" />
                        <textarea name="english_content"
                            class="content">{{ old('english_content') }}</textarea>
                        <x-jet-input-error for="english_content" class="mt-2" />
                    </div>

                    <!-- Content ID -->
                    <div class="col-span-6" x-show="lang == 'id'">
                        <x-jet-label for="content" value="{{ __('ui.post.content') . ' ' . __('[ID]') }}"
                            class="mb-1" />
                        <textarea name="indonesia_content"
                            class="content">{{ old('indonesia_content') }}</textarea>
                        <x-jet-input-error for="indonesia_content" class="mt-2" />
                    </div>

                    <!-- Meta Description EN -->
                    <div class="col-span-6 md:col-span-3" x-show="lang == 'en'">
                        <x-jet-label for="english_meta_description"
                            value="{{ __('ui.post.meta') . ' ' . __('[EN]') }}" />
                        <x-input-textarea id="english_meta_description" name="english_meta_description"
                            class="block w-full mt-1" rows="3">
                            {{ old('english_meta_description') }}</x-input-textarea>
                    ...
                    <div class="col-span-6 md:col-span-3" x-show="lang == 'id'">
                        <x-jet-label for="indonesia_meta_description"
                            value="{{ __('ui.post.meta') . ' ' . __('[ID]') }}" />
                        <x-input-textarea id="indonesia_meta_description" name="indonesia_meta_description"
                            class="block w-full mt-1" rows="3">
                            {{ old('indonesia_meta_description') }}</x-input-textarea>
                        <x-input-info for="indonesia_meta_description"
                            message="Panjang deskripsi yang disarankan adalah 155-160 karakter."
                            class="mt-2" />
                    ...
                    <x-slot name="actions">
                        ...
                        <x-jet-button name="action" value="publish">
                            {{ __('ui.publish') }}
                        </x-jet-button>
